...
Replace this section with the supported versions for `dotpath`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `dotpath` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in dotpath.
